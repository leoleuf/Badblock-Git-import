...
!function (n) {
    ...
    if (be.FE.LinkRegExCommon = "[a-z\\u0080-\\u009f\\u00a1-\\uffff0-9-_.]{1,}", be.FE.LinkRegExEnd = "((:[0-9]{1,5})|)(((\\/|\\?|#)[a-z\\u00a1-\\uffff0-9@?\\|!^=%&amp;/~+#-\\'*-_{}]*)|())", be.FE.LinkRegExTLD = "((" + be.FE.LinkRegExCommon + ")(\\.(com|net|org|edu|mil|gov|co|biz|info|me|dev)))", be.FE.LinkRegExHTTP = "((ftp|http|https):\\/\\/" + be.FE.LinkRegExCommon + ")", be.FE.LinkRegExAuth = "((ftp|http|https):\\/\\/[\\u0021-\\uffff]{1,}@" + be.FE.LinkRegExCommon + ")", be.FE.LinkRegExWWW = "(www\\." + be.FE.LinkRegExCommon + "\\.[a-z0-9-]{2,24})", be.FE.LinkRegEx = "(" + be.FE.LinkRegExTLD + "|" + be.FE.LinkRegExHTTP + "|" + be.FE.LinkRegExWWW + "|" + be.FE.LinkRegExAuth + ")" + be.FE.LinkRegExEnd, be.FE.LinkProtocols = ["mailto", "tel", "sms", "notes", "data"], be.FE.MAIL_REGEX = /.+@.+\..+/i, be.FE.MODULES.helpers = function (a) {
            ...
            function e() {
                ...
                var e = c.opts.iframe ? c.$iframe.prev().outerHeight(!0) : c.$el.prev().outerHeight(!0), t = 0, n = 0,
                    r = 0, i = 0, a = 0, o = 0, s = c.node.contents(c.el),
            ...
            function t(e) {
                ...
                u.node.hasClass(e.get(0), "fr-dropdown") ? function (e) {
                    var t = e.next(), n = u.node.hasClass(e.get(0), "fr-active"),
            ...
            return {
                _init: function () {
                    ...
                    if (d[e]) {
                        var t = d[e], n = t.$modal, r = t.$body, i = be(l.o_win).height(),
                        ...
                        return h = i, g.events.on("popup.tab", function (e) {
                            ...
                            if (be.FE.KEYCODE.TAB == n) {
                                ...
                                if (t.is("span.fr-select-color")) {
                                    var a = t.parent().find("span.fr-select-color"), o = a.index(t),
                                        s = g.opts.colorsStep, l = Math.floor(a.length / s), d = o % s,
                                        c = Math.floor(o / s), f = c * s + d, p = l * s;
    ...
    be.FE.DEFAULTS.imageInsertButtons.push("imageManager"), be.FE.RegisterCommand("imageManager", {
    ...
    }), be.FE.DefineIcon("lineHeight", {NAME: "arrows-v"}), be.extend(be.FE.POPUP_TEMPLATES, {
        "link.edit": "[_BUTTONS_]",
    ...
    }), be.FE.DefineIcon("getPDF", {NAME: "file-pdf-o"}), be.FE.RegisterCommand("getPDF", {
        title: "Download PDF",
        type: "button",
        focus: !1,
        undo: !1,
    ...
    }, be.FE.DefineIcon("save", {NAME: "floppy-o", FA5NAME: "disk"}), be.FE.RegisterCommand("save", {
        title: "Save",
        undo: !1,
        focus: !1,
        refreshAfterCallback: !1,
        ...
        specialCharactersSets: [{
            ...
            }, {"char": "&sup3;", desc: "SUPERSCRIPT THREE"}, {"char": "&acute;", desc: "ACUTE ACCENT"}, {
                "char": "&micro;",
                desc: "MICRO SIGN"
            }, {"char": "&para;", desc: "PILCROW SIGN"}, {"char": "&middot;", desc: "MIDDLE DOT"}, {
                "char": "&cedil;",
                desc: "CEDILLA"
            ...
            list: [{"char": "&#x20A0", desc: "EURO-CURRENCY SIGN"}, {
                ...
                "char": "&#x20AF",
                desc: "DRACHMA SIGN"
            }, {"char": "&#x20B0", desc: "GERMAN PENNY SYMBOL"}, {"char": "&#x20B1", desc: "PESO SIGN"}, {
                "char": "&#x20B2",
                desc: "GUARANI SIGN"
            }, {"char": "&#x20B3", desc: "AUSTRAL SIGN"}, {"char": "&#x20B4", desc: "HRYVNIA SIGN"}, {
                "char": "&#x20B5",
                desc: "CEDI SIGN"
