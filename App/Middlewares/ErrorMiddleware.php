...
<div class="cover">
    ...
    <h1>OUPS! Une erreur est survenue</h1>
        <p class="lead">Code d\'erreur : '. $requestCode .'</p>
        <p class="lead">Merci de conserver ce code pour une meilleure asistance !</p>
                <p>Discord de BadBlock : <a href="https://badblock.fr/discord">Rejoindre !</a></p>
    <footer>
