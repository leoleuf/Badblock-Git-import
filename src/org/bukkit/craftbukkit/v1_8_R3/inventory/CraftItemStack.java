...
import static org.bukkit.craftbukkit.v1_8_R3.inventory.CraftMetaItem.ENCHANTMENTS;
import static org.bukkit.craftbukkit.v1_8_R3.inventory.CraftMetaItem.ENCHANTMENTS_ID;
import static org.bukkit.craftbukkit.v1_8_R3.inventory.CraftMetaItem.ENCHANTMENTS_LVL;
...
public final class CraftItemStack extends ItemStack {
    ...
    public static net.minecraft.server.v1_8_R3.ItemStack asNMSCopy(ItemStack original) {
     ...
     */
    public static ItemStack asBukkitCopy(net.minecraft.server.v1_8_R3.ItemStack original) {
        if (original == null) {
    ...
    public void setTypeId(int type) {
        if (getTypeId() == type) {
            ...
            handle = new net.minecraft.server.v1_8_R3.ItemStack(CraftMagicNumbers.getItem(type), 1, 0);
        } else {
