	...
	public boolean generate(World world, Random random, BlockPosition blockposition) {
        ...
        if (blockposition.getY() < 1) {
            ...
            for (int i = 0; i < 4; ++i) {
                ...
                if (world.isEmpty(blockposition1) && World.a(world, blockposition1.down())) {
                    ...
                    if (world.isEmpty(blockposition3) && World.a(world, blockposition3.down())) {
                        world.setTypeAndData(blockposition3, Blocks.TORCH.getBlockData(), 2);
                    }

                    if (world.isEmpty(blockposition2) && World.a(world, blockposition2.down())) {
                        world.setTypeAndData(blockposition2, Blocks.TORCH.getBlockData(), 2);
                    }

                    if (world.isEmpty(blockposition4) && World.a(world, blockposition4.down())) {
                        world.setTypeAndData(blockposition4, Blocks.TORCH.getBlockData(), 2);
                    }

                    if (world.isEmpty(blockposition5) && World.a(world, blockposition5.down())) {
