...
public class DedicatedServer extends MinecraftServer implements IMinecraftServer {
	...
	protected boolean init() throws IOException {
		...
		global.addHandler(new org.bukkit.craftbukkit.v1_8_R3.util.ForwardLogHandler());
		...
		new Thread(new org.bukkit.craftbukkit.v1_8_R3.util.TerminalConsoleWriterThread(System.out, this.reader)).start();
        ...
        String serverName = System.getProperty("serverName", this.propertyManager.getString("server-name", "unknow"));
