...
public abstract class BiomeBase {
    ...
    public final float a(BlockPosition blockposition) {
        if (blockposition.getY() > 64) {
            float f = (float) (BiomeBase.ae.a(blockposition.getX() * 1.0D / 8.0D, blockposition.getZ() * 1.0D / 8.0D) * 4.0D);
    ...
    public EnumTemperature m() {
        return this.temperature < 0.2D ? EnumTemperature.COLD : (this.temperature < 1.0D ? EnumTemperature.MEDIUM : EnumTemperature.WARM);
    }
