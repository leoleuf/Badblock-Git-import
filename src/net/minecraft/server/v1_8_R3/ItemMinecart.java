    ...
    public boolean interactWith(ItemStack itemstack, EntityHuman entityhuman, World world, BlockPosition blockposition, EnumDirection enumdirection, float f, float f1, float f2) {
        ...
        if (BlockMinecartTrackAbstract.d(iblockdata)) {
            if (!world.isClientSide) {
                ...
                org.bukkit.event.player.PlayerInteractEvent event = org.bukkit.craftbukkit.v1_8_R3.event.CraftEventFactory.callPlayerInteractEvent(entityhuman, org.bukkit.event.block.Action.RIGHT_CLICK_BLOCK, blockposition, enumdirection, itemstack);
