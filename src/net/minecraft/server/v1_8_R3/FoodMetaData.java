...
public class FoodMetaData {
    ...
    public void a(ItemFood itemfood, ItemStack itemstack) {
        ...
        org.bukkit.event.entity.FoodLevelChangeEvent event = org.bukkit.craftbukkit.v1_8_R3.event.CraftEventFactory.callFoodLevelChangeEvent(entityhuman, itemfood.getNutrition(itemstack) + oldFoodLevel);
    ...
    public void a(EntityHuman entityhuman) {
        ...
        if (this.exhaustionLevel > 4.0F) {
            ...
            if (this.saturationLevel > 0.0F) {
                ...
                // CraftBukkit start
                org.bukkit.event.entity.FoodLevelChangeEvent event = org.bukkit.craftbukkit.v1_8_R3.event.CraftEventFactory.callFoodLevelChangeEvent(entityhuman, Math.max(this.foodLevel - 1, 0));
