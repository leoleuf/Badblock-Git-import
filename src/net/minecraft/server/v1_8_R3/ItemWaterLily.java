        ...
        if (movingobjectposition == null) {
            ...
            if (movingobjectposition.type == MovingObjectPosition.EnumMovingObjectType.BLOCK) {
                ...
                if (iblockdata.getBlock().getMaterial() == Material.WATER && iblockdata.get(BlockFluids.LEVEL).intValue() == 0 && world.isEmpty(blockposition1)) {
                    ...
                    org.bukkit.event.block.BlockPlaceEvent placeEvent = org.bukkit.craftbukkit.v1_8_R3.event.CraftEventFactory.callBlockPlaceEvent(world, entityhuman, blockstate, blockposition.getX(), blockposition.getY(), blockposition.getZ());
