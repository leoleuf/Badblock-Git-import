...
public class EntityArrow extends Entity implements IProjectile {
	...
	public void t_() {
        ...
        if (this.inGround) {
            ...
            if (movingobjectposition != null) {
                org.bukkit.craftbukkit.v1_8_R3.event.CraftEventFactory.callProjectileHitEvent(this); // CraftBukkit - Call event
	...
	public void d(EntityHuman entityhuman) {
        if (!this.world.isClientSide && this.inGround && this.shake <= 0) {
            ...
            if (this.fromPlayer == 1 && entityhuman.inventory.canHold(itemstack) > 0) {
                ...
                PlayerPickupItemEvent event = new PlayerPickupItemEvent((org.bukkit.entity.Player) entityhuman.getBukkitEntity(), new org.bukkit.craftbukkit.v1_8_R3.entity.CraftItem(this.world.getServer(), this, item), 0);
