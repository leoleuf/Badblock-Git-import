...
public class EntityTracker {
	...
	private Set<EntityTrackerEntry> c = Collections.synchronizedSet(Sets.newConcurrentHashSet());
	...
	public void a(Entity entity, @SuppressWarnings("rawtypes") Packet packet) {
		synchronized (thread) {
	...
	public void sendPacketToEntity(Entity entity, @SuppressWarnings("rawtypes") Packet packet) {
		synchronized (thread) {
			EntityTrackerEntry entitytrackerentry = this.trackedEntities.get(entity.getId());
