...
public abstract class Entity implements ICommandListener {
    ...
    public void setSize(float f, float f1) {
        if (f != this.width || f1 != this.length) {
            ...
            this.width = f;
            this.length = f1;
            this.a(new AxisAlignedBB(this.getBoundingBox().a, this.getBoundingBox().b, this.getBoundingBox().c, this.getBoundingBox().a + this.width, this.getBoundingBox().b + this.length, this.getBoundingBox().c + this.width));
        ...
        try {
            ...
            if (this instanceof EntityPlayer) {
                ...
                if (bworld == null) {
                    ...
                    bworld = ((org.bukkit.craftbukkit.v1_8_R3.CraftServer) server).getServer().getWorldServer(entityPlayer.dimension).getWorld();
                }
    ...
    public EntityItem a(ItemStack itemstack, float f) {
        if (itemstack.count != 0 && itemstack.getItem() != null) {
            ...
            if (this instanceof EntityLiving && ((EntityLiving) this).drops != null) {
                ((EntityLiving) this).drops.add(org.bukkit.craftbukkit.v1_8_R3.inventory.CraftItemStack.asBukkitCopy(itemstack));
                return null;
            }
            // CraftBukkit end
