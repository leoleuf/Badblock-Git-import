...
public class StatisticManager {
    ...
    public void b(EntityHuman entityhuman, Statistic statistic, int i) {
        if (!statistic.d() || this.b((Achievement) statistic)) {
            ...
            org.bukkit.event.Cancellable cancellable = org.bukkit.craftbukkit.v1_8_R3.event.CraftEventFactory.handleStatisticsIncrease(entityhuman, statistic, this.getStatisticValue(statistic), i);
