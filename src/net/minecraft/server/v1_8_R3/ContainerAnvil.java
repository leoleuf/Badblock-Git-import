...
public class ContainerAnvil extends Container {
	...
	public boolean a(EntityHuman entityhuman) {
        ...
        return this.i.getType(this.j).getBlock() != Blocks.ANVIL ? false : entityhuman.e(this.j.getX() + 0.5D, this.j.getY() + 0.5D, this.j.getZ() + 0.5D) <= 64.0D;
    }
    ...
    public CraftInventoryView getBukkitView() {
        ...
        org.bukkit.craftbukkit.v1_8_R3.inventory.CraftInventory inventory = new org.bukkit.craftbukkit.v1_8_R3.inventory.CraftInventoryAnvil(this.h, this.g);
