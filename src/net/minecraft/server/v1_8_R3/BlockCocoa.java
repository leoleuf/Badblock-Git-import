...
public class BlockCocoa extends BlockDirectional implements IBlockFragilePlantElement {
    ...
    public BlockCocoa() {
        ...
        this.j(this.blockStateList.getBlockData().set(BlockDirectional.FACING, EnumDirection.NORTH).set(BlockCocoa.AGE, Integer.valueOf(0)));
        this.a(true);
    }
	...
	public IBlockData getPlacedState(World world, BlockPosition blockposition, EnumDirection enumdirection, float f, float f1, float f2, int i, EntityLiving entityliving) {
        ...
        return this.getBlockData().set(BlockDirectional.FACING, enumdirection.opposite()).set(BlockCocoa.AGE, Integer.valueOf(0));
    }
	...
	public IBlockData fromLegacyData(int i) {
        return this.getBlockData().set(BlockDirectional.FACING, EnumDirection.fromType2(i)).set(BlockCocoa.AGE, Integer.valueOf((i & 15) >> 2));
    }
