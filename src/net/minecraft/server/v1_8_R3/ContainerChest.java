...
public class ContainerChest extends Container {
    ...
    public CraftInventoryView getBukkitView() {
        ...
        if (this.container instanceof PlayerInventory) {
            inventory = new org.bukkit.craftbukkit.v1_8_R3.inventory.CraftInventoryPlayer((PlayerInventory) this.container);
        } else if (this.container instanceof InventoryLargeChest) {
            inventory = new org.bukkit.craftbukkit.v1_8_R3.inventory.CraftInventoryDoubleChest((InventoryLargeChest) this.container);
        } else {
