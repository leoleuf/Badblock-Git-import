...
public class TileEntityHopper extends TileEntityContainer implements IHopper, IUpdatePlayerListBox {
                ...
                for (int i = 0; i < this.getSize(); ++i) {
                    if (this.getItem(i) != null) {
                        ...
                        if (iinventory instanceof InventoryLargeChest) {
                            destinationInventory = new org.bukkit.craftbukkit.v1_8_R3.inventory.CraftInventoryDoubleChest((InventoryLargeChest) iinventory);
                        } else {
    ...
    private static boolean a(IHopper ihopper, IInventory iinventory, int i, EnumDirection enumdirection) {
        ...
        if (itemstack != null && b(iinventory, itemstack, i, enumdirection)) {
            ...
            // Have to special case large chests as they work oddly
            if (iinventory instanceof InventoryLargeChest) {
                sourceInventory = new org.bukkit.craftbukkit.v1_8_R3.inventory.CraftInventoryDoubleChest((InventoryLargeChest) iinventory);
            } else {
