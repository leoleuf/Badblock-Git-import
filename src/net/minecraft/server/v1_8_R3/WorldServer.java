...
public class WorldServer extends World implements IAsyncTaskHandler {
    ...
    public WorldServer(MinecraftServer minecraftserver, IDataManager idatamanager, WorldData worlddata, int i, MethodProfiler methodprofiler, org.bukkit.World.Environment env, org.bukkit.generator.ChunkGenerator gen) {
        ...
        this.Q = ((org.bukkit.craftbukkit.v1_8_R3.CraftTravelAgent) new org.bukkit.craftbukkit.v1_8_R3.CraftTravelAgent(this).setSearchRadius(paperSpigotConfig.portalSearchRadius)); // CraftBukkit // Paper - configurable search radius
        this.B();
        this.C();
