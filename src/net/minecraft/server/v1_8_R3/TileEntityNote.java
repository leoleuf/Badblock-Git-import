...
public class TileEntityNote extends TileEntity {
    ...
    public void play(World world, BlockPosition blockposition) {
        if (world.getType(blockposition.up()).getBlock().getMaterial() == Material.AIR) {
            ...
            // CraftBukkit start
            org.bukkit.event.block.NotePlayEvent event = org.bukkit.craftbukkit.v1_8_R3.event.CraftEventFactory.callNotePlayEvent(this.world, blockposition.getX(), blockposition.getY(), blockposition.getZ(), b0, this.note);
