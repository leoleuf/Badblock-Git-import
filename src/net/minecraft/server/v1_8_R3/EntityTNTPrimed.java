...
public class EntityTNTPrimed extends Entity {
    ...
    private void explode() {
        ...
        org.bukkit.craftbukkit.v1_8_R3.CraftServer server = this.world.getServer();

        ExplosionPrimeEvent event = new ExplosionPrimeEvent((org.bukkit.entity.Explosive) org.bukkit.craftbukkit.v1_8_R3.entity.CraftEntity.getEntity(server, this));
