    ...
    static void b() {
        ...
        BlockDispenser.REGISTRY.a(Items.FIRE_CHARGE, new DispenseBehaviorItem() {
            public ItemStack b(ISourceBlock isourceblock, ItemStack itemstack) {
                ...
                entitysmallfireball.projectileSource = new org.bukkit.craftbukkit.v1_8_R3.projectiles.CraftBlockProjectileSource((TileEntityDispenser) isourceblock.getTileEntity());
