...
public abstract class MinecraftServer implements Runnable, ICommandListener, IAsyncTaskHandler, IMojangStatistics {
	...
	public void stop() throws ExceptionWorldConflict { // CraftBukkit - added throws
		...
		if (!this.N) {
			...
			if (this.v != null) {
				if(BadblockConfig.config.shutdown.savePlayers){
			...
			if (BadblockConfig.config.shutdown.saveWorld && this.worldServer != null) {
			...
			// Spigot start
			if( org.spigotmc.SpigotConfig.saveUserCacheOnStopOnly && BadblockConfig.config.shutdown.savePlayers )
			{
