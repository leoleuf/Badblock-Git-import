...
public class EntityEnderDragon extends EntityInsentient implements IComplex, IMonster {
        ...
        if (this.random.nextInt(2) == 0 && !arraylist.isEmpty()) {
            ...
            if (!event.isCancelled()) {
                if (event.getTarget() == null) {
                    ...
                    this.target = ((org.bukkit.craftbukkit.v1_8_R3.entity.CraftEntity) event.getTarget()).getHandle();
                }
            }
            // CraftBukkit end
        } else {
    ...
    private boolean b(AxisAlignedBB axisalignedbb) {
        ...
        org.bukkit.craftbukkit.v1_8_R3.CraftWorld craftWorld = this.world.getWorld();
        // CraftBukkit end
