    ...
    static class PathfinderGoalEndermanPickupBlock extends PathfinderGoal {
		...
		public void e() {
            ...
            if (EntityEnderman.c.contains(block)) {
                ...
                if (!org.bukkit.craftbukkit.v1_8_R3.event.CraftEventFactory.callEntityChangeBlockEvent(this.enderman, this.enderman.world.getWorld().getBlockAt(blockposition.getX(), blockposition.getY(), blockposition.getZ()), org.bukkit.Material.AIR).isCancelled()) {
    ...
    static class PathfinderGoalEndermanPlaceBlock extends PathfinderGoal {
		...
		public void e() {
            ...
            if (this.a(world, blockposition, this.a.getCarried().getBlock(), block, block1)) {
                ...
                if (!org.bukkit.craftbukkit.v1_8_R3.event.CraftEventFactory.callEntityChangeBlockEvent(this.a, blockposition.getX(), blockposition.getY(), blockposition.getZ(), this.a.getCarried().getBlock(), this.a.getCarried().getBlock().toLegacyData(this.a.getCarried())).isCancelled()) {
