...
public abstract class DispenseBehaviorProjectile extends DispenseBehaviorItem {
	...
	public ItemStack b(ISourceBlock isourceblock, ItemStack itemstack) {
        ...
        BlockDispenseEvent event = new BlockDispenseEvent(block, craftItem.clone(), new org.bukkit.util.Vector((double) enumdirection.getAdjacentX(), (double) (enumdirection.getAdjacentY() + 0.1F), (double) enumdirection.getAdjacentZ()));
