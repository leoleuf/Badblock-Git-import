...
/**
 * Provides a common base implementation for injectable filters. This
 * implementation does not propagate calls to previous filters when injected,
 * however subclasses may do that.
 *
