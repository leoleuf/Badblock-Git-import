...
import fr.badblock.bungeecord.api.event.ServerConnectedEvent;
import fr.badblock.bungeecord.api.event.ServerKickEvent;
import fr.badblock.bungeecord.api.event.ServerSwitchEvent;
...
import fr.badblock.bungeecord.connection.CancelSendSignal;
import fr.badblock.bungeecord.connection.DownstreamBridge;
import fr.badblock.bungeecord.connection.LoginResult;
import fr.badblock.bungeecord.forge.ForgeConstants;
import fr.badblock.bungeecord.forge.ForgeServerHandler;
import fr.badblock.bungeecord.forge.ForgeUtils;
...
public class ServerConnector extends PacketHandler
{
    ...
    public void handle(Login login) throws Exception
    {
        ...
        } else
        {
            ...
            {
                user.unsafe().sendPacket( new fr.badblock.bungeecord.protocol.packet.Team( team.getName() ) );
            }
            ...
            for ( UUID bossbar : user.getSentBossBars() )
            {
                ...
                user.unsafe().sendPacket( new fr.badblock.bungeecord.protocol.packet.BossBar( bossbar, 1 ) );
            }
