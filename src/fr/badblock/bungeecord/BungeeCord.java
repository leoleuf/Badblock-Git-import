...
import fr.badblock.bungeecord.api.ReconnectHandler;
...
import fr.badblock.bungeecord.chat.TextComponentSerializer;
import fr.badblock.bungeecord.chat.TranslatableComponentSerializer;
import fr.badblock.bungeecord.command.CommandEnd;
import fr.badblock.bungeecord.command.CommandPlugins;
import fr.badblock.bungeecord.command.CommandPluginsManager;
import fr.badblock.bungeecord.command.CommandReload;
import fr.badblock.bungeecord.command.CommandServer;
import fr.badblock.bungeecord.command.ConsoleCommandSender;
import fr.badblock.bungeecord.compress.CompressFactory;
import fr.badblock.bungeecord.conf.Configuration;
import fr.badblock.bungeecord.conf.YamlConfig;
import fr.badblock.bungeecord.forge.ForgeConstants;
import fr.badblock.bungeecord.log.BungeeLogger;
import fr.badblock.bungeecord.log.LoggingOutputStream;
...
import fr.badblock.bungeecord.query.RemoteQuery;
import fr.badblock.bungeecord.scheduler.BungeeScheduler;
...
public class BungeeCord extends ProxyServer
{
...

	{
		...
		getPluginManager().registerCommand( null, new CommandPluginsManager() );
