...
public class InventoryModMuteListener  extends BadListener {

	public InventoryModMuteListener(Plugin plugin)
	{
		super(plugin);
	}
	...
	public void onInteractWindow(InteractWindowEvent event)
	{
		...
		String workTitle = badPlayer.getTranslatedMessage("bungee.commands.mod.mute.inventory_name", null, "");
		...
		ProxyServer.getInstance().getPluginManager().dispatchCommand(player, "m mute " + playerName + " " + reason);
	}
