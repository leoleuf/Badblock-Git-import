...
public class InventoryModBanIPListener  extends BadListener {

	public InventoryModBanIPListener(Plugin plugin)
	{
		super(plugin);
	}
	...
	public void onInteractWindow(InteractWindowEvent event)
	{
		...
		String workTitle = badPlayer.getTranslatedMessage("bungee.commands.mod.banip.inventory_name", null, "");
		...
		ProxyServer.getInstance().getPluginManager().dispatchCommand(player, "m banip " + playerName + " " + reason);
	}
