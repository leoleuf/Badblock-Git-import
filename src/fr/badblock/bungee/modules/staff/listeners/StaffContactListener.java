...
public class StaffContactListener  extends BadListener {

	public StaffContactListener(Plugin plugin)
	{
		super(plugin);
	}
	...
	public void onInteractWindow(InteractWindowEvent event)
	{
		...
		String workTitle = badPlayer.getTranslatedMessage("bungee.commands.staff.inventory_name", null, "");
		...
		String playerName = stack.getName();
		...
		ProxyServer.getInstance().getPluginManager().dispatchCommand(player, "staff " + playerName);
	}
