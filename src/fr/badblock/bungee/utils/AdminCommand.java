...
public class AdminCommand extends Command {
	...
	public void execute(CommandSender sender, String[] args) {
		LadderBungee.getInstance().rabbitService.sendPacket("admin.broadcast", "§r[&6§l" + sender.getName() + "§r] &8> §b" + StringUtils.join(args, " "), Encodage.UTF8, RabbitPacketType.PUBLISHER, 5000, false);
	}
