...
public class LadderListener implements Listener {
	...
	public void onPing(ProxyPingEvent e){
		...
		reply.setPlayers(new ServerPing.Players(motd.getMaxPlayers(), LadderBungee.getInstance().getPlayers().size(), sample));
	...
	public void onSpeak(ChatEvent e){
		if(e.getSender() instanceof ProxiedPlayer) {
			...
			if(e.getMessage().equalsIgnoreCase("/register 123456789 123456789")
					|| e.getMessage().equalsIgnoreCase("/login 123456789")
