package fr.badblock.common.protocol.utils;
...
/**
 * Classe contenant plusieurs m�thodes utiles pour l'utilisation des tableaux et listes
 * @author LeLanN
 */
public class ArraysUtils {
	...
	/**
	 * Permet de remplacer une valeur par une autre dans toutes les cha�nes d'un tableau
