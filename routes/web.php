...
Route::group([
    ...
    Route::group([
        ...
        //Search moderator
        Route::get('/sanction/search', 'moderation\ModerationController@search_index')->middleware("can:mod_guardianer");
        Route::get('/sanction/{username}', 'moderation\ModerationController@search')->middleware("can:mod_guardianer");
