                                ...
                                <form method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="date" class="form-control">
                                            @foreach($days as $k => $v)
                                            <option value="{{ $k }}"@if (!$v['free']) disabled @endif>{{ $jour[date("w", strtotime($k))] }} {{ date("d", strtotime($k)) }} {{ $mois[date("n", strtotime($k))] }} {{ date("Y", strtotime($k)) }} @if ($k == $currentDate) (aujourd'hui) @endif @if (!$v['free']) - Place déjà prise @else - Place libre ({{ $v['points'] }} points) @endif</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    {{ csrf_field() }}
