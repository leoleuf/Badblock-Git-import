@section('title', 'Conditions d\'utilisation | Serveur-Multigames.net')
@section('description', 'Découvrez les conditions d\'utilisation du site Internet Serveur-Multigames ainsi que des services qui y sont associés, afin de mettre un point de clarté sur les prises de connaissance par rapport au Service et par rapport au rôle de l\'Utilisateur final')
@section('logometa', 'https://serveur-multigames.net/img/logo.png')
@section('canonical', 'https://serveur-multigames.net/tos')
                ...
                <h1>Conditions d'utilisation</h1>
                    <p>
                        <blockquote class="generic-blockquote">
                            ...
                            Serveur-Multigames.net est un site Internet, disponible uniquement par le biais de l'adresse Web-Internet
                            <a title="Serveur Multigames" href="https://serveur-multigames.net">https://serveur-multigames.net/</a>, ainsi que tous les sous-domaines et routes associés au service.
                            Ce service répertorie tous les serveurs gratuits sur simple création de serveur, par l'Utilisateur final, qui est soumis à la charte
                            officielle, notamment appelée <a title="Règlement du site MultiGames" href="https://serveur-multigames.net/reglement">Règlement du site Internet et du Service pour l'Utilisateur final</a>.<br />
                            Les données fournies et les actions effectuées sur le service, par le biais de l'adresse Web-Internet ainsi que toutes les formes associées sont enregistrées
                        ...
                        <blockquote class="generic-blockquote">
                            ...
                            souhaite porter à la connaissance (notamment par les actions envoyées depuis le biais de notre adresse Web-Internet). Nous nous engagons à ne vendre aucune de vos
                            données personnelles à des services, à des organisations, que ce soit à but lucratif ou à but non lucratif, qui ne sont pas affilié(e)s au service proposé.
                            Certaines données sont récoltées pour pouvoir vous proposer le meilleur contenu ainsi qu'avec un objectif à des fins de ciblages pour les publicités du prestataire
                            Google, notamment désactivables depuis le site Internet de Google. Nous n'avons pas la responsabilité de l'usage des données récoltées par les publicités. Cependant,
                        ...
                        <blockquote class="generic-blockquote">
                            ...
                            associés. L'Utilisateur final n'a donc aucun droit sur l'engagement d'une quelconque responsabilité du service et/ou du site Internet concernant les liens externes et/ou hypertextes, le contenu
