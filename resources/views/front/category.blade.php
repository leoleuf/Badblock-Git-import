                        ...
                        @if (isset($catName) && $catName == "minecraft")
                            <div class="single-slidebar">
                                ...
                                <div class="active-relatedjob-carusel single-rated">
                                        ...
                                        <p>
                                            <a class="ticker-btn d-flex" title="Ajouter son serveur Minecraft" href="/dashboard/add-server"><span class="fa fa-plus-circle"></span> Ajouter mon serveur Minecraft</a>
                                        </p>
                            </div>
                            </div>
                        @endif
