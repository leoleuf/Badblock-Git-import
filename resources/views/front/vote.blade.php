            ...
            <div class="row justify-content-center d-flex">
                <div class="col-lg-8 post-list">
                    ...
                    <div class="single-post d-flex flex-row">
                                ...
                                @else
                                    <form method="post" id="vote-form">
                                        ...
                                        <button class="g-recaptcha btn btn-success col-12" id="vote_button"
                                                ...
                                                data-callback="onSubmit" style="display: none; height: 80px; margin-top: -20px;" disabled>
                        ...
                        <ins class="adsbygoogle" id="ad2" style="display: block; height: 60px; max-width: 350px; max-height: 300px;"
