                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="m-b-30">
                                                        ...
                                                        <a href="/website" id="addToTable"
                                                           class="btn btn-primary waves-effect waves-light">Retour <i
                                                                    class="fa fa-long-arrow-left"></i></a>
                                                        <a href="/website/crud/product/create" id="addToTable"
                        ...
                        @foreach($Categories as $row)
                            ...
                            @endforeach
                                            ...
                                            @foreach($Categories as $cat)
                                                <div id="cat_{{ str_replace(" ", "_", $cat->name) }}" class=""
                                                     style="display: block;">
                                                                ...
                                                                <td>
                                                                    <div>
                                                                        ...
                                                                        <a class="btn btn-small btn-info"
                                                                           href="{{ URL::to('website/crud/product/' . $value->_id . '/edit') }}">Edit</a>
