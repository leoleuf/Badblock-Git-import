...
public class TeamTag {
    ...
    public TeamTag(String name, String prefix, String suffix, Scoreboard current) throws Exception {
        this.prefix = prefix;
        this.suffix = suffix;
    ...
    public TeamTag(String name, String prefix, String suffix) throws Exception {
    ...
    public static void setNameTag(Player player, String name, String prefix) {
        try {
            TeamTag tagplayer = new TeamTag(name, prefix, null);
